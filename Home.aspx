<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="Superomart.Home" %>
            ...
            <ul class="list-unstyled components">
                ...
                <li class="active"> <a href="home.aspx">Home</a></li>
                 <li> <a href="about.aspx">About</a></li>
                                        ...
                                        <li> <a href="register.aspx">Sign in/Sign up</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 logo_section">
                                <div class="full">
                                    <div class="center-desk">
                                        <div class="logo text-bg">
                                            <a href="index.html"><h1><strong class="black_bold">SUPEROMART</strong></h1></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                <div class="right_header_info">
                                    <ul>
                                        <li>
                                            <a href="register.aspx"><img style="margin-right: 15px;" src="icon/1.png" alt="#" /></a>
                                        </li>
                                        <li class="tytyu">
